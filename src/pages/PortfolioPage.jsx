        ...
        <div className="space-y-6">
            <header className="rounded-2xl border border-slate-800 bg-slate-950/80 p-5 shadow-lg shadow-black/20">
                ...
                <div className="mt-4 overflow-x-auto">
                    <div className="flex min-w-full gap-3 snap-x snap-mandatory sm:min-w-[720px]">
                        {summaryCards.map((card) => (
                            <div
                                key={card.label}
                                className={`flex flex-1 min-w-[170px] flex-col justify-between rounded-xl border border-slate-800 px-4 py-3 ${card.accent} snap-start`}
                            >
